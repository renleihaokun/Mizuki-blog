...
<div class="relative z-50">
	...
	>
		...
		<div
			class="absolute transition-all duration-300 ease-in-out flex items-center justify-center"
		...
		>
			<div class="relative w-9 h-9 flex items-center justify-center">
				<Icon
					icon="material-symbols:wb-sunny-outline-rounded"
					class="text-[0.85rem] absolute top-1.5 right-1.5"
				></Icon>
				<Icon
					icon="material-symbols:dark-mode-outline-rounded"
					class="text-[0.85rem] absolute bottom-1.5 left-1.5"
				></Icon>
			</div>
		</div>
	</button>
