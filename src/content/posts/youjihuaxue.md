...
* 分子内氢键形成5/6元环降低沸点  
* 烯醇(邻二酮会变成烯醇)和苯酚都能与$\mathrm{FeCl_3}$发生显色反应  
* 酚可和酸(巨困难)、酰氯、酸酐反应生成酯  
...
* 康尼查罗反应：不含$\mathrm{α-H}$的醛自己歧化生成酸+醇/把甲醛氧化了自己被还原，看不出来发生什么反应不妨想想这个  
...
| 方法 | 试剂 | 适用 | 产物 |
| :--- | :--- | :--- | :--- |
| **克莱门森** | $Zn(Hg)/HCl$ | 对酸不敏感 | 烃 |
| **黄鸣龙** | $NH_2NH_2/NaOH$ | 对碱不敏感 | 烃 |
| **$NaBH_4$** | $NaBH_4$ | 选择性还原 $C=O$ | 醇 |
| **$H_2/Ni$** | $H_2/Ni, \Delta$ | 同时还原 $C=C$ 和 $C=O$ | 醇 |

#### 3. α-H 的反应

* **羟醛缩合**：有 α-H + **稀碱** → β-羟基醛/酮
* **Cannizzaro**：无 α-H + **浓碱** → 醇 + 羧酸盐
* **碘仿反应**：含 $CH_3CO-$ 结构 + $I_2/NaOH$ → $CHI_3$↓ (黄色)

#### 4. 醛酮鉴别

* **Tollens 试剂**：醛 → 银镜；酮 → 不反应
* **Fehling 试剂**：脂肪醛 → $Cu_2O$ 砖红色；酮 → 不反应

### 第五部分：羧酸及其衍生物 (02-2.pdf)

#### 1. 酸性

* **酸性顺序**：羧酸 > $H_2CO_3$ > 酚 > $H_2O$ > 醇
* **NaHCO₃ 鉴别**：羧酸 → $CO_2$↑；酚 → 不反应
...
* **反应**：RCOOH + R'OH ⇌ RCOOR' + $H_2O$ (酸催化，可逆)
* **机理**：羧酸脱 -OH，醇脱 -H
...
* 中性：$pI = (pK_{a1} + pK_{a2})/2$
* 酸性：$pI = (pK_{a1} + pK_{aR})/2$
* 碱性：$pI = (pK_{a2} + pK_{aR})/2$
...
* **甲酸 vs 其他酸**：银氨溶液
* **乙二酸 vs 其他酸**：$KMnO_4$
* **伯/仲/叔胺**：$NaNO_2/HCl$ 或 Hinsberg 试验
* **α/β-糖苷**：麦芽糖酶/苦杏仁酶

#### 反应条件

* **克莱门森**：$Zn(Hg)/HCl$，酸敏感不适用
* **黄鸣龙**：$NH_2NH_2/NaOH$，碱敏感不适用
* **羟醛缩合**：有 α-H + 稀碱
* **Cannizzaro**：无 α-H + 浓碱

#### 反应方程式

* $2HCHO \xrightarrow{浓NaOH} HCOONa + CH_3OH$ (Cannizzaro)
* $RCH_2COOH + Br_2 \xrightarrow{PCl_3} RCHBrCOOH$ (α-卤代)
* 氨基酸 + 茚三酮 → 紫蓝色化合物
